...
use uuid::Uuid;
use crate::{domain::dto::{company_dto::{ReqCreateCompanyDto, ReqUpdateCompanyDto, ResEntryCompanyDto, ResListCompanyDto, ResUpdateCompanyDto}, std_201::ResCreateSuccess}, infrastructure::mysql::repositories::impl_company_repository::CompanyRepositoryError};
...
pub trait CompanyRepoReqImpl {
    ...
    async fn update_company(&self, user_id: Uuid, company_id: Uuid, company_data: ReqUpdateCompanyDto) -> Result<ResUpdateCompanyDto, CompanyRepositoryError>;
